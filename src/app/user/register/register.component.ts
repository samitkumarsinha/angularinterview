...
export class RegisterComponent implements OnInit {
  ...
  onregister(){
    ...
    const country = this.regform.get('country').value;
    const address = this.regform.get('address').value;
    const city = this.regform.get('city').value;
    ...
    const data = {'name': username, 'email': email, 'password': password,  'country': country,  'address': address,  'city': city};
